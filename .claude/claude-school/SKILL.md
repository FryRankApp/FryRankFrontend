...
Export well-formatted learning summaries of coding sessions to `.claude/claude-school-outputs/` (relative to the project root, i.e. the `FryRankFrontend` directory).
